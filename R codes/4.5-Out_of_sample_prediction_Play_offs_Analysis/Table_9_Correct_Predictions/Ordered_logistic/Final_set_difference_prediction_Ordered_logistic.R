...
#### The observed Finals-Final results
finals_train_home_team<-c(7,12,7,12,7)
finals_train_away_team<-c(12,7,12,7,12)
finals_train_home_sets<-c(3,3,2,0,1)
finals_train_away_sets<-c(0,0,3,3,3)



test_dataList_new_final<-list(n_teams=12,n_games=length(finals_train_home_team),
                              home_team=finals_train_home_team,
                              away_team=finals_train_away_team,
                              home_sets=finals_train_home_sets,
                              away_sets=finals_train_away_sets)
...
rstan_ordered_final_table9<-stan(file.choose(),data=model_dataList_new_final,chains=3,thin=2,
...
mean(out_of_sample_deviance_set_diff_ordered)###1.60
