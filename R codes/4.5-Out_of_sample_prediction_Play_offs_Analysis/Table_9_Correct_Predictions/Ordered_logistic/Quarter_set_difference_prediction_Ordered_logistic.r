...
test_dataList_new_final<-list(n_teams=12,n_games=length(quarter_train_home_team),
...
rstan_ordered_quarter_table9<-stan(file.choose(),data=model_dataList_new_final,chains=3,thin=2,
