...
test_dataList<-list(n_teams=length(teams_names),
                    n_games=length(c(7,12,7,12,7)),
					home_team=c(7,12,7,12,7),
          away_team=c(12,7,12,7,12),
					home_sets=c(3,3,2,0,1),
					away_sets=c(0,0,3,3,3))
...
mean(out_of_sample_deviance_set_diff_zdts)###2.71
sd(out_of_sample_deviance_set_diff_zdts)###
