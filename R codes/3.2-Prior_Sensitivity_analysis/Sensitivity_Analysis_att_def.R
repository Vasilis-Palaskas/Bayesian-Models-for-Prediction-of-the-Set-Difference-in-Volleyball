...
model {
  ...
  target+=normal_lpdf(attack|0,1*sqrt(c));
  target+=normal_lpdf(defense|0,1*sqrt(c));
...
# c=2
ZDTS_paper_att_def_c_2<-stan(model_code=sensit_att_def.stan,data=dataList_c_2,thin=1,chains=1,
...
# c=5
ZDTS_paper_att_def_c_5<-stan(model_code=sensit_att_def.stan,data=dataList_c_5,thin=1,chains=1,
iter=2000,warmup=1000,seed="12345",init_r=1)

# c=10
ZDTS_paper_att_def_c_10<-stan(model_code=sensit_att_def.stan,data=dataList_c_10,thin=1,chains=1,
iter=2000,warmup=1000,seed="12345",init_r=1)

# c=20
ZDTS_paper_att_def_c_20<-stan(model_code=sensit_att_def.stan,data=dataList_c_20,thin=1,chains=1,
iter=2000,warmup=1000,seed="12345",init_r=1)
# Save the results of all fitted models
#save(ZDTS_paper_att_def_c_2,file="ZDTS_paper_att_def_c_2")#2 divergent transitions
#save(ZDTS_paper_att_def_c_5,file="ZDTS_paper_att_def_c_5")#33 divergent transitions
#save(ZDTS_paper_att_def_c_10,file="ZDTS_paper_att_def_c_10")#106 divergent transitions
#save(ZDTS_paper_att_def_c_20,file="ZDTS_paper_att_def_c_20")#206 divergent transitions
...
#load(file.choose())#Output\Sensitivity analysis\att_def parameter\ZDTS_paper_att_def_c_5
#load(file.choose())#Output\Sensitivity analysis\att_def parameter\ZDTS_paper_att_def_c_10
#load(file.choose())#Output\Sensitivity analysis\att_def parameter\ZDTS_paper_att_def_c_20



#Print output of candidate models
print(ZDTS_paper_att_def_c_5,pars=c("mu","home","attack","defense","dev"))
print(ZDTS_paper_att_def_c_10,pars=c("mu","home","attack","defense","dev"))
print(ZDTS_paper_att_def_c_20,pars=c("mu","home","attack","defense","dev"))


# Extraction of the candidate models' deviances
#c=2
dev_sensit_att_def_c_2<-extract(ZDTS_paper_att_def_c_2,pars="dev")
dev_sensit_att_def_c_2$dev

mean(dev_sensit_att_def_c_2$dev)#357.4
sd(dev_sensit_att_def_c_2$dev)#6.5
#c=5
dev_sensit_att_def_c_5<-extract(ZDTS_paper_att_def_c_5,pars="dev")
dev_sensit_att_def_c_5$dev

mean(dev_sensit_att_def_c_5$dev)#357.9
sd(dev_sensit_att_def_c_5$dev)#7.0

#Model c=10
dev_sensit_att_def_c_10<-extract(ZDTS_paper_att_def_c_10,pars="dev")
dev_sensit_att_def_c_10$dev
