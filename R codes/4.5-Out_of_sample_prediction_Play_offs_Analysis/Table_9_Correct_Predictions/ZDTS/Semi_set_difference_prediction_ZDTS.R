...
train_dataList<-list(n_teams=12,
                     n_games=length(datafr_teams_scores_set_win$home_score)+length(quarter_train_away_sets),
                     ...
                     home_team=c(as.numeric(factor(datafr_teams_scores_set_win$home_Team)),
                                 quarter_train_home_team),
                     away_team=c(as.numeric(factor(datafr_teams_scores_set_win$away_Team)),
                                 quarter_train_away_team))
...
test_dataList<-list(n_teams=12,
                    n_games=length(semi_train_home_team),
...
mean(out_of_sample_deviance_set_diff_zdts)###1.44
